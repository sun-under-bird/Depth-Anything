...
if __name__ == '__main__':
    ...
    parser.add_argument('--load-from', type=str, default=None, help='path to model checkpoint')
    ...
    checkpoint_path = args.load_from or f'checkpoints/depth_anything_v2_{args.encoder}.pth'
